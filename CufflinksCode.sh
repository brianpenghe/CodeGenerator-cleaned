...
while read line
    do
        printf "condor_run \" /woldlab/castor/proj/programs/cufflinks-1.3.0.Linux_x86_64/cufflinks -p 8 --compatible-hits-norm --GTF /woldlab/castor/home/phe/genomes/mm9/Mus_musculus.NCBIM37.67.filtered.removingENSMUST00000127664.gtf --output-dir "$line"."$2"."$3"Cufflinks1.3.0 \" "$line"."$2"."$3"/accepted_hits.bam && " >> testcodeCufflinks
        ...
        printf "awk '{print \$1\$7\"\\\t\"\$0}' "$line"."$2"."$3"Cufflinks1.3.0/genes.fpkm_tracking | sort -k 1d,1  > "$line"."$2"."$3"Cufflinks1.3.0/genes.fpkm_trackingSorted & \n" >> testcodeCufflinks
