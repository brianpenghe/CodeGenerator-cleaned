...
while read line
    do
        ...
        $(if [ -e $line.'$2'.'$3'merlS50000mD50s150fL0.HOMER.whole.bed ]; then wc -l $line.'$2'.'$3'merlS50000mD50s150fL0.HOMER.whole.bed | cut -d" " -f1; else echo 0; fi) \
        $(if [ -e $line.'$2'.'$3'merlS50000mD50s150fL0.HOMER.bed ]; then wc -l $line.'$2'.'$3'merlS50000mD50s150fL0.HOMER.bed | cut -d" " -f1; else echo 0; fi) \
