...
if [[ "$1" == "PE" ]]
    then
        ...
        printf "~/.local/bin/cutadapt -a CTGTCTCTTATACAC "$2"R1all.fastq | ~/.local/bin/cutadapt -g TGCCGTCTTCTGCTTG - | ~/.local/bin/cutadapt -g CTTTGTGTTTGA - > "$2"R1trimmedfastq && " >> testcode
        printf "~/.local/bin/cutadapt -a CTGTCTCTTATACAC "$2"R2all.fastq | ~/.local/bin/cutadapt -g TGCCGTCTTCTGCTTG - | ~/.local/bin/cutadapt -g CTTTGTGTTTGA - > "$2"R2trimmedfastq && " >> testcode
    ...
    then
        ...
        printf "~/.local/bin/cutadapt -a CTGTCTCTTATACAC "$2"all.fastq | ~/.local/bin/cutadapt -g TGCCGTCTTCTGCTTG - | ~/.local/bin/cutadapt -g CTTTGTGTTTGA - > "$2"trimmedfastq && " >> testcode
