...
if [[ "$1" == "PE" ]]
    then
        ...
        printf "~/.local/bin/cutadapt -a CTGTCTCTTATACAC "$2"R1allfastq > "$2"R1trimmedfastq 2> "$2"R1trimmedfastq.log && "
        printf "~/.local/bin/cutadapt -a CTGTCTCTTATACAC "$2"R2allfastq > "$2"R2trimmedfastq 2> "$2"R2trimmedfastq.log && "
    ...
    then
        ...
        printf "~/.local/bin/cutadapt -a CTGTCTCTTATACAC "$2"allfastq > "$2"trimmedfastq 2> "$2"trimmedfastq.log && "
