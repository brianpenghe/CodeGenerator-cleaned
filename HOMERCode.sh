...
while read line
    do
        ...
        printf "/woldlab/loxcyc/proj/genome/programs/homer-4.7/bin/findPeaks "$line"."$2"."$3"HomerTags -localSize 50000 -minDist 50 -size 150 -fragLength 0 -o "$line"."$2"."$3"lS50000mD50s150fL0 2> "$line"."$2"."$3"lS50000mD50s150fL0.err && " >> testcodeHOMER
        ...
        printf "/woldlab/loxcyc/proj/genome/programs/x86_64/bedToBigBed "$line"."$2"."$3"lS50000mD50s150fL0.bed "$chromsizes" "$line"."$2"."$3"lS50000mD50s150fL0.bigBed && " >> testcodeHOMER
        printf "/woldlab/loxcyc/proj/genome/programs/x86_64/bedToBigBed "$line"."$2"."$3"lS50000mD50s150fL0.whole.bed "$chromsizes" "$line"."$2"."$3"lS50000mD50s150fL0.whole.bigBed && " >> testcodeHOMER
        ...
        printf "echo 'RiP:' \$(intersectBed -abam "$line"."$2"."$3".unique.dup.bam -b "$line"."$2"."$3"lS50000mD50s150fL0.bed | /woldlab/loxcyc/proj/genome/programs/samtools-0.1.16/bin/samtools view -c - ) > "$line"."$2"."$3".lS50000mD50s150fL0.stats && " >> testcodeHOMER
        printf "echo 'RiPwhole:' \$(intersectBed -abam "$line"."$2"."$3".unique.dup.bam -b "$line"."$2"."$3"lS50000mD50s150fL0.whole.bed | /woldlab/loxcyc/proj/genome/programs/samtools-0.1.16/bin/samtools view -c - ) >> "$line"."$2"."$3".lS50000mD50s150fL0.stats && " >> testcodeHOMER
        printf "echo 'RiChrM:' \$(/woldlab/loxcyc/proj/genome/programs/samtools-0.1.16/bin/samtools view -c "$line"."$2"."$3".unique.dup.bam chrM ) >> "$line"."$2"."$3".lS50000mD50s150fL0.stats && " >> testcodeHOMER
        printf "echo 'Rtotal:' \$(/woldlab/loxcyc/proj/genome/programs/samtools-0.1.16/bin/samtools view -c "$line"."$2"."$3".unique.dup.bam ) >> "$line"."$2"."$3".lS50000mD50s150fL0.stats & \n" >> testcodeHOMER
    done <$1
